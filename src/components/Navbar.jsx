      ...
      <div className="container mx-auto flex justify-center items-center gap-6">
        <Link
          ...
          className={`group relative font-semibold text-lg transition-colors duration-200 ${
            isActive('/') ? 'text-blue-900' : 'text-blue-600 hover:text-blue-800'
          }`}
        >
          🏠 Home
          <span
        ...
        <Link
          to="/info"
          className={`group relative font-semibold text-lg transition-colors duration-200 ${
            isActive('/info') ? 'text-green-800' : 'text-green-600 hover:text-green-800'
          }`}
        >
          📚 Info
          <span
        ...
        <Link
          to="/good-habits"
          className={`group relative font-semibold text-lg transition-colors duration-200 ${
            isActive('/good-habits') ? 'text-purple-800' : 'text-purple-600 hover:text-purple-800'
          }`}
        >
          ✨ Good Habits
          <span
            className={`absolute left-0 -bottom-1 h-0.5 bg-purple-700 transition-all duration-200 ${
              isActive('/good-habits') ? 'w-full' : 'w-0 group-hover:w-full'
            }`}
          />
        </Link>
      </div>
